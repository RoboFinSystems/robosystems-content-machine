...
def check_companion_formats(project_dir, ticker, script):
    ...
    # --- Shorts: backburnered (2026-07). Nothing is authored for them; the avatar-short
    # tooling stays on the shelf (`just short` / `just shorts`) and postpack only picks a
...
def check_publish_metadata(project_dir, ticker, script):
    ...
    has_short = False  # shorts backburnered 2026-07: tooling kept (`just short[s]`), no authored copy expected
    expected = [
        "youtube_title",
        "x_first_comment",
