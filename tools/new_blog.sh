...
echo ""
echo "Next:"
echo "  1. Edit blog/$SLUG/post.md (frontmatter + body). Link the previous lesson in its series"
echo "     (and edit that one to link forward here) and one product page on the same site"
