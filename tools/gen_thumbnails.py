...
STYLE = (
    ...
    "hook_stat (the single most striking metric, 1-4 words, e.g. '4.4% YIELD', 'BELOW BOOK'), "
    "hook_line (a punchy 2-5 word tension phrase, e.g. 'MARKET DOESN'T TRUST IT'), "
    "key_stat (one supporting figure WITH its label for a small badge, e.g. '52-WEEK LOW ~$135.84'), "
...
def build_prompt(el, aspect_note):
    return (
        ...
        f"{el['chart_hint']}, upper right. On the left, bold condensed headline text stacked: "
