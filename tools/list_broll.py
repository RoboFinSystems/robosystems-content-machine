...
CATEGORIES = [
  (
    ...
    {"cultivation", "grow", "production", "operations", "canopy"},
  ),
  ...
  (
    "Mood (bull / bear)",
    {"relief", "bullish", "risk", "bearish", "mood", "uncertainty"},
  ),
...
def main():
  if not os.path.exists(MANIFEST):
    print(
      "No b-roll manifest yet. Add clips to assets/broll/ then run: just broll-sync"
    )
    return
