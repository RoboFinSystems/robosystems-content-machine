...
the loop — no hand-off to a design app, no clipboard round-trip. You do **not** author
...
**The hand-composed 16:9 deck path is retired.** It ran the script through a design app, came
back as a PPTX, and rendered in the cloud. That whole middle is gone: `assemble_video.py` and its
Shotstack render were deleted on 2026-08-08, `DESIGN_INSTRUCTIONS.md` on 2026-09-03, and both
live only in git history. Rendering is local now (puppeteer-core + ffmpeg). Ignore any
instruction to produce a deck brief, a PPTX or a PDF.
